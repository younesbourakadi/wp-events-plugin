...
class Metal_Slug
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Metal_Slug_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Metal_Slug_Loader. Orchestrates the hooks of the plugin.
	 * - Metal_Slug_i18n. Defines internationalization functionality.
	 * - Metal_Slug_Admin. Defines all hooks for the admin area.
	 * - Metal_Slug_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Metal_Slug_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
